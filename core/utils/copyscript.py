from rest.dwapi import datawiz, datawiz_upload, datawiz_auth
...
def main(start_date, log = 'test1222@mail.com', pas = '1qaz'):

    try:
        updw = datawiz_auth.Auth(API_KEY=log, API_SECRET=pas)
        print('AWESOME')
    except:
        print('HOUSTON')
